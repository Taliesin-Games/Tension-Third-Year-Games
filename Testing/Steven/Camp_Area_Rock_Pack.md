...
| Are the normal maps set up properly in unity? There is a chekc box to set them as normal maps.|✅|
...
- The book is not optimised properly yet and will be changed afterwards, I needed this branch sorted for Claire.
