...
|---------|----------|----------------|--------|
| Portal Shader Graph | Can I make a  portal Material and apply it to a mesh| ✅ | 
| Portal Shader Configs | Can I modify public parameters on portal Material to create interesting effects?| ✅ | 
